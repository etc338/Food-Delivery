  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
      {showSearch && userData.role == "user" && (
        <div className="flex md:hidden fixed top-[80px] left-[5%] w-[90%] h-[70px] bg-white shadow-xl rounded-lg items-center gap-[20px] z-[9998]">
          <div className="flex items-center w-[30%] overflow-hidden gap-[10px] px-[10px] border-r-[2px] border-gray-400">
            <FaLocationDot size={25} className="text-[#ff4d2d]" />
            <div className="w-[80%] truncate text-gray-600">{currentCity || "Select City"}</div>
          </div>
          <div className="flex items-center w-[80%] gap-[10px] pr-[10px]">
